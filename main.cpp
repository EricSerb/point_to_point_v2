...
void testSynthetic(std::string testSyntheticFile, std::string testSyntheticGraph, int n) {
	...
	Lemon L(D0.getGraph(), &LG);
	Lemon L2(D0.getGraph(), &LG2);
	Lemon L3(D0.getGraph(), &LG3);
	...
	if (n < 500) {
		...
		timeit2<milliseconds>(&Lemon::kruskalsTrim, &Lemon::initDistributionCenterSeqAfterTrim, L2, KRUSKDIJKSEQ);
		timeit2<milliseconds>(&Lemon::kruskalsTrim, &Lemon::initDistributionCenterAfterTrim, L3, KRUSKDIJK);
		timeit<milliseconds>(&Lemon::kruskalsTrim, L, KRUSKAL);
	} else {
		timeit<seconds>(&Lemon::initDistributionCenterSeq, L, DIJKSTRASEQ);
		timeit<seconds>(&Lemon::initDistributionCenter, L, DIJKSTRA);
		timeit2<seconds>(&Lemon::kruskalsTrim, &Lemon::initDistributionCenterSeqAfterTrim, L2, KRUSKDIJKSEQ);
		timeit2<seconds>(&Lemon::kruskalsTrim, &Lemon::initDistributionCenterAfterTrim, L3, KRUSKDIJK);
		timeit<seconds>(&Lemon::kruskalsTrim, L, KRUSKAL);
	}
}
